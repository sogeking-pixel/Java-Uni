...
public class PagarReserva_ extends javax.swing.JFrame {
    ...
    private void btnPagarActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String lectura = archivo.cursoYProfesCompleto(nr, lrCursos, lrProfes, lrReserva);
        String fechaReserva = descomponerLineaNombres(lectura, 52, 67);
