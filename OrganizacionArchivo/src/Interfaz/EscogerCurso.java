 ...
 * @author yerso
 */
public class EscogerCurso  extends JFrame implements ActionListener {
    ...
    public EscogerCurso(VentanaDocente v){ //metodo constructor: inicia la clase
      
      setLayout(null);
      Regitrara=new JButton("enseñar curso");      
